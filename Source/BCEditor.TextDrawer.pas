...
uses
  Windows, SysUtils, Classes, Graphics, Math, Types, System.UITypes,
  BCEditor.Utils;
...
begin
  ...
  Windows.ExtTextOut(FHandle, X, Y, 0, @LTempRect, AText, ALength, nil);
end;
...
begin
  ...
  Windows.ExtTextOut(FHandle, X, Y, AOptions, @ARect, AText, ALength, Pointer(FExtTextOutDistance));
end;
